  ...
  const navigation = [
    { name: "Inicio", href: "/" },
    {
      ...
      children: [
        ...
        { name: "Para terapeutas", href: "/terapeutas" },
        { name: "Para nutricionistas", href: "/nutricionistas" },
      ],
    },
    { name: "Funcionalidades", href: "/footer/funcionalidades"},
    { name: "Precios", href: "/footer/precios" },
    { name: "Contacto", href: "/footer/contacto" },
  ]
